...
//#define kUrl @"http://client-api.dingdone.com/L5KNWJ18PY/141764/listcontents?column_id=219686&from=%ld&size=15"
...
- (void)viewDidLoad {
    ...
    self.count = 0;
    [self downloadWithUrl:[NSString stringWithFormat:kPointUrl,self.count]];
...
-(void)createDropDownRefresh
{
    ...
    [self.tableView addRefreshHeaderViewWithAniViewClass:[JHRefreshCommonAniView class] beginRefresh:^{
        ...
        weakSelf.count = 0;
        [weakSelf downloadWithUrl:[NSString stringWithFormat:kPointUrl,weakSelf.count]];
