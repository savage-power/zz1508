...
//#define kUrl @"http://client-api.dingdone.com/L5KNWJ18PY/141764/listcontents?column_id=261283&from=%ld&size=15"
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.count = 0;
    [self downloadWithUrl:[NSString stringWithFormat:kInternetUrl,self.count]];
...
-(void)createDropDownRefresh
{
    ...
    [self.tableView addRefreshHeaderViewWithAniViewClass:[JHRefreshCommonAniView class] beginRefresh:^{
        ...
        weakSelf.count = 0;
        [weakSelf downloadWithUrl:[NSString stringWithFormat:kInternetUrl,weakSelf.count]];
